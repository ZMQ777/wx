Page({
    ...
    goods: {
      ...
      weizhenmeisu: {
        ...
        goodsDetailImg: [
          ...
          "http://odwbo6hwu.bkt.clouddn.com/webapp/img/detail/pifu/weizhenmeisu/good-detail_03.jpg",
          "http://odwbo6hwu.bkt.clouddn.com/webapp/img/detail/pifu/weizhenmeisu/good-detail_04.jpg"
        ]
      },
      zhongxifadou: {
        goodsBanner: [
  ...
  onLoad: function (options) {
    ...
    if (list == "pifu") {
      switch (project) {
        case "Eguangmeibainenfu":
          this.setData({
            pageGoodInfo: this.data.goods.Eguangmeibainenfu,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "Eguangshuiyang":
          this.setData({
            pageGoodInfo: this.data.goods.Eguangshuiyang,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "guomingyuanjiance":
          this.setData({
            pageGoodInfo: this.data.goods.guomingyuanjiance,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "huizhijiajiancha":
          this.setData({
            pageGoodInfo: this.data.goods.huizhijiajiancha,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "pifujiancha":
          this.setData({
            pageGoodInfo: this.data.goods.pifujiancha,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "qiangxiaoqudou":
          this.setData({
            pageGoodInfo: this.data.goods.qiangxiaoqudou,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "qudouVISIAshuiyangsanheyi":
          this.setData({
            pageGoodInfo: this.data.goods.qudouVISIAshuiyangsanheyi,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "shuiyanghuofu":
          this.setData({
            pageGoodInfo: this.data.goods.shuiyanghuofu,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "tuofajiancha":
          this.setData({
            pageGoodInfo: this.data.goods.tuofajiancha,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "VISIApifujiance":
          this.setData({
            pageGoodInfo: this.data.goods.VISIApifujiance,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "weizhenmeisu":
          this.setData({
            pageGoodInfo: this.data.goods.weizhenmeisu,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "yechoushoushu":
          this.setData({
            pageGoodInfo: this.data.goods.yechoushoushu,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "yiyongmianmo":
          this.setData({
            pageGoodInfo: this.data.goods.yiyongmianmo,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
        case "zhongxifadou":
          this.setData({
            pageGoodInfo: this.data.goods.zhongxifadou,
            pageHotGood: this.data.hotGoods.pifu
          })
          break;
      }
      ...
      switch (project) {
        case "man1":
          this.setData({
            pageGoodInfo: this.data.goods.man1,
            pageHotGood: this.data.hotGoods.man
          })
          break;
        case "man2":
          this.setData({
            pageGoodInfo: this.data.goods.man2,
            pageHotGood: this.data.hotGoods.man
          })
          break;
        case "man3":
          this.setData({
            pageGoodInfo: this.data.goods.man3,
            pageHotGood: this.data.hotGoods.man
          })
          break;
        case "man4":
          this.setData({
            pageGoodInfo: this.data.goods.man4,
            pageHotGood: this.data.hotGoods.man
          })
          break;
      }
      ...
      switch (project) {
        case "women1":
          this.setData({
            pageGoodInfo: this.data.goods.women1,
            pageHotGood: this.data.hotGoods.women
          })
          console.log(this.data.pageGoodInfo)
          break;
        case "women2":
          this.setData({
            pageGoodInfo: this.data.goods.women2,
            pageHotGood: this.data.hotGoods.women
          })
          break;
        case "women3":
          this.setData({
            pageGoodInfo: this.data.goods.women3,
            pageHotGood: this.data.hotGoods.women
          })
          break;
        case "women4":
          this.setData({
            pageGoodInfo: this.data.goods.women4,
            pageHotGood: this.data.hotGoods.women
          })
          break;
        case "women5":
          this.setData({
            pageGoodInfo: this.data.goods.women5,
            pageHotGood: this.data.hotGoods.women
          })
          break;
        case "women6":
          this.setData({
            pageGoodInfo: this.data.goods.women6,
            pageHotGood: this.data.hotGoods.women
          })
          break;
      }
